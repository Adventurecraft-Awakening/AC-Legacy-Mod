 ...
 * @see Collection
 */
public interface ByteCollection extends Collection<Byte>, it.unimi.dsi.fastutil.bytes.ByteIterable {
	/**
	...
	default IntIterator intIterator() {
		return it.unimi.dsi.fastutil.bytes.ByteIterable.super.intIterator();
	}
	 ...
	 *
	 * <p>
	 * See {@link Collection#spliterator()} for more documentation on the requirements of the
	...
	default ByteSpliterator spliterator() {
		return it.unimi.dsi.fastutil.bytes.ByteSpliterators.asSpliterator(iterator(), sizeOf(this), ByteSpliterators.COLLECTION_SPLITERATOR_CHARACTERISTICS);
	}
	 ...
	 *
	 * <p>
	 * Note that this method should be called {@link Collection#remove(Object) remove()}, but
