...
public class ByteImmutableList extends ByteLists.ImmutableListBase implements ByteList, RandomAccess, Cloneable, java.io.Serializable {
	...
	public ByteListIterator listIterator(final int index) {
		...
		return new ByteListIterator() {
			...
			public void forEachRemaining(final ByteConsumer action) {
				final byte[] a = ByteImmutableList.this.a;
				while (pos < a.length) {
					action.accept(a[pos++]);
				}
			}
	...
	private final class Spliterator implements ByteSpliterator {
		...
		public int characteristics() {
			return it.unimi.dsi.fastutil.bytes.ByteSpliterators.LIST_SPLITERATOR_CHARACTERISTICS | java.util.Spliterator.IMMUTABLE;
		}
	...
	private final static class ImmutableSubList extends ByteLists.ImmutableListBase implements RandomAccess, java.io.Serializable {
		...
		public ByteListIterator listIterator(final int index) {
			...
			return new ByteListIterator() {
				...
				@Override
				public void forEachRemaining(final ByteConsumer action) {
					final byte[] a = ImmutableSubList.this.a;
					while (pos < to) {
						action.accept(a[pos++]);
					}
				}
		...
		private final class SubListSpliterator extends it.unimi.dsi.fastutil.bytes.ByteSpliterators.EarlyBindingSizeIndexBasedSpliterator {
