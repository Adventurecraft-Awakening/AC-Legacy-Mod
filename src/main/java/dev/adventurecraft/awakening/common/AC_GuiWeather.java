...
public class AC_GuiWeather extends Screen {
    ...
    public AC_GuiWeather(World var1, AC_TileEntityWeather var2) {
        this.weather = var2;
    }
    ...
    public void initVanillaScreen() {
        OptionButtonWidget var1 = new OptionButtonWidget(0, 4, 0, "Don\'t Change Precipitation");
        this.buttons.add(var1);
        if (this.weather.changePrecipitate) {
            if (this.weather.precipitate) {
                var1.text = "Start Precipitation";
            } else {
                var1.text = "Stop Precipitation";
            }
        }

        var1 = new OptionButtonWidget(1, 4, 22, "Don\'t Change Temperature");
        this.buttons.add(var1);
        if (this.weather.changeTempOffset) {
            var1.text = "Change Temperature";
        }
        ...
        var1 = new OptionButtonWidget(3, 4, 66, "Don\'t Change Time");
        this.buttons.add(var1);
        if (this.weather.changeTimeOfDay) {
            var1.text = "Change Time";
        }
        ...
        var1 = new OptionButtonWidget(5, 4, 110, "Don\'t Change Time Rate");
        this.buttons.add(var1);
        if (this.weather.changeTimeRate) {
            var1.text = "Change Time Rate";
        }
        ...
        var1 = new OptionButtonWidget(7, 4, 152, "Don\'t Change Thundering");
        this.buttons.add(var1);
        if (this.weather.changeThundering) {
            if (this.weather.thundering) {
                var1.text = "Start Thundering";
            } else {
                var1.text = "Stop Thundering";
            }
        }
    ...
    protected void buttonClicked(ButtonWidget var1) {
        if (var1.id == 0) {
            ...
            if (this.weather.changePrecipitate) {
                ...
                var1.text = "Don\'t Change Precipitation";
            }
        }
        ...
        if (var1.id == 7) {
            ...
            if (this.weather.changeThundering) {
                ...
                var1.text = "Don\'t Change Thundering";
            }
        } else if (var1.id == 1) {
            ...
            if (this.weather.changeTempOffset) {
                ...
                var1.text = "Don\'t Change Temperature";
            }
        } else if (var1.id == 3) {
            ...
            if (this.weather.changeTimeRate) {
                ...
                var1.text = "Don\'t Change Time Rate";
            }
        }
    ...
    public static void showUI(World var0, AC_TileEntityWeather var1) {
        Minecraft.instance.openScreen(new AC_GuiWeather(var0, var1));
    }
