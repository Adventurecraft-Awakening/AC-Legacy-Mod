...
public class AC_GuiTriggerInverter extends Screen {
    ...
    public AC_GuiTriggerInverter(World var1, int var2, int var3, int var4, AC_TileEntityTriggerInverter var5) {
        this.world = var1;
        this.blockX = var2;
        this.blockY = var3;
        this.blockZ = var4;
    ...
    public static void showUI(World var0, int var1, int var2, int var3, AC_TileEntityTriggerInverter var4) {
        Minecraft.instance.openScreen(new AC_GuiTriggerInverter(var0, var1, var2, var3, var4));
    }
