...
public class AC_GuiTrigger extends Screen {
    ...
    public AC_GuiTrigger(World var1, int var2, int var3, int var4, AC_TileEntityTrigger var5) {
        this.world = var1;
        this.blockX = var2;
        this.blockY = var3;
        this.blockZ = var4;
    ...
    protected void buttonClicked(ButtonWidget var1) {
        int var2;
        if (var1.id == 0) {
            var2 = this.world.getBlockId(this.blockX, this.blockY, this.blockZ);
    ...
    public static void showUI(World var0, int var1, int var2, int var3, AC_TileEntityTrigger var4) {
        Minecraft.instance.openScreen(new AC_GuiTrigger(var0, var1, var2, var3, var4));
    }
