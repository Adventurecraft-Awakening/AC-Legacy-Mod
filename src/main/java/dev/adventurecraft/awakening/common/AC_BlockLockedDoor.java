...
public class AC_BlockLockedDoor extends Block implements AC_ITriggerBlock {
    ...
    public boolean shouldRender(BlockView view, int x, int y, int z) {
        int var5 = view.getBlockMeta(x, y, z);
    ...
    public int getTextureForSide(BlockView var1, int var2, int var3, int var4, int var5) {
        if (var5 != 0 && var5 != 1) {
            int var6 = 1;
            while (var1.getBlockId(var2, var3 + var6, var4) == this.id) {
                ++var6;
            }
            ...
            if (var6 > 2) {
                if (var6 / 2 == var7 - 1) {
                    ...
                    var7 = 1;
                    while (var1.getBlockId(var2 + var9, var3, var4) == this.id) {
                        ++var9;
                    }
    ...
    @Override
    public int alwaysUseClick(World world, int x, int y, int z) {
        return 0;
    }
}
