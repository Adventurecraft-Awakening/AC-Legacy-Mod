...
public class AC_Items {
    ...
    public static Item pistol = (new AC_ItemPistol(217)).setTexturePosition(192).setTranslationKey("pistol").setDurability(15).setRendered3d();
    public static Item rifle = (new AC_ItemRifle(218)).setTexturePosition(193).setTranslationKey("rifle").setDurability(30).setRendered3d();
    public static Item shotgun = (new AC_ItemShotgun(219)).setTexturePosition(194).setTranslationKey("shotgun").setDurability(7).setRendered3d();
    ...
    public static Item npcStick = (new AC_ItemNPCStick(306)).setTranslationKey("npcStick").setRendered3d();
