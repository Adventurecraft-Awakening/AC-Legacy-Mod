...
public final class AC_GuiStrings {
    ...
    public static String formatMin(IntVec3 min) {
        return String.format("Min: (%d, %d, %d)", min.x(), min.y(), min.z());
    }

    public static String formatMax(IntVec3 max) {
        return String.format("Max: (%d, %d, %d)", max.x(), max.y(), max.z());
    }

    public static void drawMinMax(Screen screen, IntVec3 min, IntVec3 max, int x, int y, int color) {
