...
public class ScriptEntityArrow extends ScriptEntity {
    ...
    public void setOwner(Mob entity){((ExArrowEntity)this.entityArrow).setOwner(entity);}

    public void setOwner(ScriptEntityPlayer entity){this.setOwner(entity.entityPlayer);}
}
